<#
.SYNOPSIS
    Silently uninstalls the Twingate client, removes ghost network adapters,
    and deletes all Twingate network profiles from the registry.
.NOTES
...
# ==============================================================================
Write-Host "`nStopping Twingate..." -ForegroundColor Yellow
...
# ==============================================================================
Write-Host "`nUninstalling Twingate..." -ForegroundColor Yellow
...
try {
    ...
    # Continue to cleanup steps even if not installed
}
...
# ==============================================================================
Write-Host "`nScanning for Twingate network profiles in registry..." -ForegroundColor Cyan
